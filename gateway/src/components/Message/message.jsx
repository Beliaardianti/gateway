      ...
      <div className="max-w-8xl mx-auto bg-white rounded-lg shadow-md p-6">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-gray-500">View all the messages sent.</p>
          </div>
          <button
          ...
          <table className="min-w-full bg-white border border-gray-200">
            ...
            <tbody>
              {currentItems.map((row, index) => (
                <tr key={row.msgid} className="text-gray-700 hover:bg-gray-50">
                  <td className="px-6 py-4 border-b">
                    {indexOfFirstItem + index + 1}
                  </td>
                  <td className="px-6 py-4 border-b break-all">{row.msgid}</td>
                  <td className="px-6 py-4 border-b">{row.source_addr}</td>
                  <td className="px-6 py-4 border-b">{row.destination_addr}</td>
                  <td className="px-6 py-4 border-b">{row.rate}</td>
                  <td className="px-6 py-4 border-b">{row.charge}</td>
                  <td className="px-6 py-4 border-b">
                    <span
                      className={`px-2 py-1 rounded-full text-sm font-normal ${
                        row.status === "DELIVRD"
                  ...
                  <td className="px-6 py-4 border-b">{row.uid}</td>
        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          <div className="flex space-x-1">
            ...
            {Array.from({
              ...
              if (
                pageNumber === 2 ||
                pageNumber === Math.ceil(filteredData.length / itemsPerPage) - 1
              ) {
                return (
